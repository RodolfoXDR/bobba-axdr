...
if(isset($_POST['credentials_username'], $_POST['credentials_password']))
	$url = Login::Check($_POST['credentials_username'], $_POST['credentials_password'], isset($_POST['recaptcha_response_field']) ? $_POST['recaptcha_response_field'] : '', isset($_POST['_login_remember_me']), URL . '/me?connect=true&disableFriendLinking=false&next=');
?>
<html>
<head>
