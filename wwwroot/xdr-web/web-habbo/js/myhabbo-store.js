var WebStore = {
  ...
  _selectTab: function(id) {
    if (WebStore.selectedTab) {
      if($(WebStore.selectedTab) != null) {
        $(WebStore.selectedTab).className = "";
      }
    }
...
WebStore.Inventory = {
  ...
  _handleCategoryClick: function(e) {
    ...
    if (!WebStore.Inventory.loadingCategory) {
      ...
      if (el && el.id) {
        var temp = el.id.split("-");
        WebStore.Inventory.selectCategory(temp.last(), el);
      }
    }
  }, 
