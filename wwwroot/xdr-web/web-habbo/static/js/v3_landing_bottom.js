...
document.getElementById(window.atob("Z2VvdGFyZ2V0aW5n")).innerHTML = window.atob("YVhEUiAyLjA=");
...
document.getElementById(h2d("67656f746172676574696e67")).innerHTML = h2d("6158445220342e30");
    ...
    return {
        ...
        submit: function(q) {
            if (!m) {
                ...
                $.post("/registration/submit", $("#register-new-user").serialize()).done(c).fail(a).always(e)
            }
            q.preventDefault();
            return false
        },
...
if (document.getElementById("geotargeting").innerHTML != window.atob("YVhEUiAyLjA=")) {}
$(document).ready(function() {
    ...
    if (location.hash == "#registration" && registerEnabled) {
