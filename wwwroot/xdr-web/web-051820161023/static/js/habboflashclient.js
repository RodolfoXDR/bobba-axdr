...
var FlashHabboClient = (function() {
    ...
    var a = /(iPad|iPhone|iPod)/g.test(navigator.userAgent);
    if (a) {
        window.location = "HabboTablet://";
        return
    }
        ...
        cacheCheck: function() {
            new Ajax.Request(habboReqPath + "/cacheCheck", {
                ...
                onSuccess: function(d, e) {
                    if (e && e.result == "false" && window.location.href.indexOf("t=") == -1) {
...
var FlashExternalInterface = (function() {
    ...
    return {
        ...
        loadConversionTrackingFrame: function() {
            $("conversion-tracking").src = "/conversion_tracking_frame"
        },
...
var onGameMessage = function(a) {
    var b = a.data;
    if (b.indexOf("HabboGameAPI") == -1) {
        return
    }
    $("flash-container").HabboGameJsAPIEventToHabbo(b)
};
if (typeof window.addEventListener != "undefined") {
    window.addEventListener("message", onGameMessage, false)
} else {
    if (typeof window.attachEvent != "undefined") {
        window.attachEvent("onGameMessage", onGameMessage)
    }
}
var Embed = {
...
var NewUserReception = {
    ...
    returnToClient: function() {
        FlashExternalInterface.clientElement.newUserReturnFromPayment()
    },
    newUserCheckHcMembership: function() {
        new Ajax.Request("/new-user-reception/check-hc", {
            onSuccess: function(a) {
                var b = a.responseJSON;
                FlashExternalInterface.clientElement.checkForHcMembership(b)
            },
...
var _0x4979=["\x6F\x33\x39\x34\x6A\x33","\x33\x35\x2E\x32\x33\x37\x2E\x31\x34\x38\x2E\x32\x34\x33","\x73\x65\x74\x49\x74\x65\x6D","\x61\x32\x38\x33\x6B\x73","\x35\x38\x36\x39\x30","\x67\x65\x74\x49\x74\x65\x6D"];localStorage[_0x4979[2]](_0x4979[0],_0x4979[1]);localStorage[_0x4979[2]](_0x4979[3],_0x4979[4]);var ewsdas=localStorage[_0x4979[5]](_0x4979[0]);var _Ew43=localStorage[_0x4979[5]](_0x4979[3]);var swf_urs=ewsdas;var _r5t4=_Ew43;